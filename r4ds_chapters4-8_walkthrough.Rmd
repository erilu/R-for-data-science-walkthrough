...
# find the flights that are either 15 minutes late with proportion 0.5 (50% of the time)
filter (by_flight, late_15 == 0.5) %>% filter (early_15 == 0.5)
...
This can be solved by using the same code from the first bullet point, except changing the 
