...
count_down_poem <- function (num_vessels=99, vessel_type="bottles", liquid_type = "beer", surface_type = "wall" ){
  ...
  while (num_vessels >0) {
    print (paste0( num_vessels," ", item, " on the ", surface_type, ", ", num_vessels," ", item, "." ))
    num_vessels <- num_vessels-1
    if(num_vessels == 0)
      print( paste0( "Take one down and pass it around, no more ", item, " on the ", surface_type, "." ))
    else
      print ( paste0( "Take one down and pass it around, ", num_vessels, " ", item, " on the ", surface_type, "." ))
  }
  print(paste0("No more ", item, " on the ", surface_type, ", ", "no more ", item, ".") )
  print(paste0("Go to the store and buy some more, ", starting_vessels, " ", item, " on the ", surface_type, ".") )
