...
```{r proportion_cancelled_vs_delay}
...
```{r previous_delay_corr_dep_delay}
flights %>%
  filter (dep_delay >0) %>%
...
Thanks for reading through my walkthrough of chapters 4 - 6! I hope you found my solutions to the exercises informative. A walkthrough of chapters 7 - 8 can be found at [r4ds_p3_chapters7-8_walkthrough.md](https://github.com/erilu/R-for-data-science-walkthrough/blob/master/r4ds_p3_chapters7-8_walkthrough.md).
